...
- Access to the GCP project (e.g., `rle-ruritania-cate654`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-cate654" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-cate654.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-cate654 --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-cate654.iam.gserviceaccount.com" \
  --project="rle-ruritania-cate654" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-cate654.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-cate654.
